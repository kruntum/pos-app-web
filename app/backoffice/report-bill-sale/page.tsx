...
export default function Page() {
    ...
    const downloadBillSale = (billurl: string) => {
        window.open(config.apiServer + '/' + billurl);

        //   window.location.href = config.apiServer + '/' + billurl;
    }
        ...
        <>
            <div className="card mt-3">
                ...
                <div className="card-body">
                    ...
                    <table className="table table-bordered mt-3 w-full">
                        <thead>
                            <tr>
                                <th style={{ width: '300px' }} className='text-center'>คุณสมบัติ</th>
                                <th style={{ width: '200px' }} className='text-center'>วันที่</th>
                                <th style={{ width: '200px' }} className='text-center'>รหัสบิล</th>
                                    ...
                                    <td className='text-center flex justify-between gap-2 '>
                                        <div className="gap-2">
                                            <button className='btn btn-danger me-2' onClick={() => handCancelBill(billSale.id)}>
                                                <i className='fa fa-times me-2'></i>Delete
                                            </button>
                                            ...
                                            >
                                                <i className='fa fa-info me-2'></i>Info
                                            </button>
                                            <button
                                                onClick={() => downloadBillSale(billSale.filebillUrl)}
